...
RUN_ID="word_ordering_ce_loss_gen0.0_suffix_size3_run1"
...
# approximately 0.88 hours (3185.9023 seconds)
...
#  Final: 0.006097 (step 780)
#  Best: 0.004871 (step 429)  # 'epoch': 5.43
...
# Verification layer parameters
ALPHA=0.95
BEST_EVAL_STEP="eval_429"  # just a placeholder here; no verification model exists
...
#/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_ce_loss_gen0.0_suffix_size3_run1/outputs/surface_level_eval.calibration.r1.suffix_size3.searchdepth0.temperature0.0.wikipedia.line_limit-1.eval_429.log.txt

    #Total examples: 5000
    #Verbatim exact matches (including formatting): 4624 (92.48%)
    #Exact matches (content only, first available tagged sentence): 4639 (92.78%)
    #No response: 0 (0.00%)
    #
    #Additional reference counts among parseable:
    #        verification_tp: 4624 (92.48%)
    #        verification_fp: 243 (4.86%)
    #        verification_fn: 15 (0.30%)
    #        verification_tn: 118 (2.36%)
    #
    #Word-level accuracy: 0.9791 ± 0.1191
...
#Documents with generated hard negatives: 361
...
#/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_ce_loss_gen0.0_suffix_size3_run1/outputs/surface_level_eval.combined.r1.suffix_size3.searchdepth0.temperature0.0.harvard.line_limit-1.log.txt

    #Total examples: 720
    #Verbatim exact matches (including formatting): 680 (94.44%)
    #Exact matches (content only, first available tagged sentence): 681 (94.58%)
    #No response: 0 (0.00%)
    #
    #Additional reference counts among parseable:
    #        verification_tp: 680 (94.44%)
    #        verification_fp: 29 (4.03%)
    #        verification_fn: 1 (0.14%)
    #        verification_tn: 10 (1.39%)
    #
    #Word-level accuracy: 0.9805 ± 0.0966
    #Average attempts: 1.00 (max: 1)

#/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_ce_loss_gen0.0_suffix_size3_run1/outputs/surface_level_eval.test.r1.suffix_size3.searchdepth0.temperature0.0.wikipedia.line_limit-1.log.txt

    #Total examples: 2000
    #Verbatim exact matches (including formatting): 1851 (92.55%)
    #Exact matches (content only, first available tagged sentence): 1858 (92.90%)
    #No response: 0 (0.00%)
    #
    #Additional reference counts among parseable:
    #        verification_tp: 1851 (92.55%)
    #        verification_fp: 88 (4.40%)
    #        verification_fn: 7 (0.35%)
    #        verification_tn: 54 (2.70%)
    #
    #Word-level accuracy: 0.9839 ± 0.0949
    #Average attempts: 1.00 (max: 1)

#/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_ce_loss_gen0.0_suffix_size3_run1/outputs/surface_level_eval.challenge_test.r1.suffix_size3.searchdepth0.temperature0.0.wikipedia.line_limit-1.log.txt

    #Total examples: 2000
    #Verbatim exact matches (including formatting): 1810 (90.50%)
    #Exact matches (content only, first available tagged sentence): 1816 (90.80%)
    #No response: 0 (0.00%)
    #
    #Additional reference counts among parseable:
    #        verification_tp: 1810 (90.50%)
    #        verification_fp: 139 (6.95%)
    #        verification_fn: 6 (0.30%)
    #        verification_tn: 45 (2.25%)
    #
    #Word-level accuracy: 0.9660 ± 0.1758
    #Average attempts: 1.00 (max: 1)
