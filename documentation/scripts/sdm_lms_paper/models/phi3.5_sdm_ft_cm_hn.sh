...
RUN_ID="word_ordering_sdm_loss_gen0.5_suffix_size3_run1"
...
/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_sdm_loss_gen0.5_suffix_size3_run1/outputs/run1.log.txt
/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_sdm_loss_gen0.5_suffix_size3_run1/outputs/run1.err.txt

# approximately 10.4 hours (37412.5862 seconds) on 4 gpus


python sdm_network_read_trainer_logs.py $MODEL_DIR/${MODEL_LABEL_NAME} \
--summary

    #{'eval_loss': 0.007137957029044628, 'eval_runtime': 1079.1642, 'eval_samples_per_second': 4.633, 'eval_steps_per_second': 0.073, 'epoch': 6.91}
    #  Evaluation Loss:
    #  Initial: 0.017086 (step 39)
    #  Final: 0.007576 (step 780)
    #  Best: 0.007138 (step 546)
...
# Verification layer parameters
ALPHA=0.95
BEST_EVAL_STEP="eval_546"  # for reference analysis, we use the existing layer from the best evaluation, but this will be replaced with the final run below
...
#/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_sdm_loss_gen0.5_suffix_size3_run1/outputs/surface_level_eval.calibration.r1.suffix_size3.searchdepth0.temperature0.0.wikipedia.line_limit-1.eval_546.log.txt

    #Total examples: 5000
    #Verbatim exact matches (including formatting): 4565 (91.30%)
    #Exact matches (content only, first available tagged sentence): 4612 (92.24%)
    #No response: 0 (0.00%)
    #
    #Additional reference counts among parseable:
    #        verification_tp: 4565 (91.30%)
    #        verification_fp: 228 (4.56%)
    #        verification_fn: 47 (0.94%)
    #        verification_tn: 160 (3.20%)
    #
    #Word-level accuracy: 0.9762 ± 0.1292
...
#Documents with generated hard negatives: 388
...
#/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_sdm_loss_gen0.5_suffix_size3_run1/outputs/surface_level_eval.combined.r1.suffix_size3.searchdepth0.temperature0.0.harvard.line_limit-1.log.txt

    #Total examples: 720
    #Verbatim exact matches (including formatting): 671 (93.19%)
    #Exact matches (content only, first available tagged sentence): 677 (94.03%)
    #No response: 0 (0.00%)
    #
    #Additional reference counts among parseable:
    #        verification_tp: 671 (93.19%)
    #        verification_fp: 29 (4.03%)
    #        verification_fn: 6 (0.83%)
    #        verification_tn: 14 (1.94%)
    #
    #Word-level accuracy: 0.9736 ± 0.1272
    #Average attempts: 1.00 (max: 1)

#/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_sdm_loss_gen0.5_suffix_size3_run1/outputs/surface_level_eval.test.r1.suffix_size3.searchdepth0.temperature0.0.wikipedia.line_limit-1.log.txt

    #Total examples: 2000
    #Verbatim exact matches (including formatting): 1848 (92.40%)
    #Exact matches (content only, first available tagged sentence): 1859 (92.95%)
    #No response: 0 (0.00%)
    #
    #Additional reference counts among parseable:
    #        verification_tp: 1848 (92.40%)
    #        verification_fp: 71 (3.55%)
    #        verification_fn: 11 (0.55%)
    #        verification_tn: 70 (3.50%)
    #
    #Word-level accuracy: 0.9812 ± 0.1092
    #Average attempts: 1.00 (max: 1)

#/home/jupyter/models/order/preview__phi35_sdm_verification_layer_word_ordering_sdm_loss_gen0.5_suffix_size3_run1/outputs/surface_level_eval.challenge_test.r1.suffix_size3.searchdepth0.temperature0.0.wikipedia.line_limit-1.log.txt

    #Total examples: 2000
    #Verbatim exact matches (including formatting): 1765 (88.25%)
    #Exact matches (content only, first available tagged sentence): 1785 (89.25%)
    #No response: 0 (0.00%)
    #
    #Additional reference counts among parseable:
    #        verification_tp: 1765 (88.25%)
    #        verification_fp: 154 (7.70%)
    #        verification_fn: 20 (1.00%)
    #        verification_tn: 61 (3.05%)
    #
    #Word-level accuracy: 0.9485 ± 0.2166
    #Average attempts: 1.00 (max: 1)
