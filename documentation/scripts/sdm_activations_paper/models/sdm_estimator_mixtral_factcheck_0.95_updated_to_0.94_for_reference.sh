...
### For reference, we update the trained model to use alpha=0.94 instead of the original alpha=0.95.
#########################################################################################################

# first copy the directory since we will be overwritting the output files
#cp -r /home/jupyter/models/sdm_paper/release_version/factcheck/mixtral_8x7b_classifier_0.95_1000 /home/jupyter/models/sdm_paper/release_version/factcheck/mixtral_8x7b_classifier_0.95_updated_to_0.94_1000
...
MODEL_TYPE="classifier_0.95_updated_to"
...
# update alpha value; note the use of --recalibrate_with_updated_alpha
...
--eval_only > ${MODEL_OUTPUT_DIR}/update_alpha_to_${ALPHA}.log.txt
