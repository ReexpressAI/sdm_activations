...
def print_latex_row(options, alpha_prime, latex_rows_dict_no_reject,
                    latex_rows_dict_vbll):
    if options.construct_results_latex_table_rows:
        ...
        print(
            get_latex_row(dataset_name, model_name, alpha_prime, latex_rows_dict_no_reject,
                          r'$\estimatorNoReject$', options.class_size)
        )
        print(
            get_latex_row(dataset_name, model_name, alpha_prime, latex_rows_dict_vbll,
                          r'$\estimatorVBLL$', options.class_size)
        )
